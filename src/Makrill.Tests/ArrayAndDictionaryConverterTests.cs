...
using System.Linq;
using ArrayAndDictionaryConverter = Makrill.ArrayAndDictionaryConverter;
namespace Makrill.Tests
{
    ...
    public class ArrayAndDictionaryConverterTests
    {
        ...
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<Dictionary<string, object>>(json, new ArrayAndDictionaryConverter());
        }
        private object[] DeserializeToArray(string json)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<object[]>(json, new ArrayAndDictionaryConverter());
        }
        ...
        public void CanDeserializeADictionaryWithArrayAndDictionary()
        {
            ...
            var deserialized = DeserializeToDictionary(Newtonsoft.Json.JsonConvert.SerializeObject(dictionary));
